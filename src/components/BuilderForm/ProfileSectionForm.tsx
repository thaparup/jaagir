...
// import { CreditCard, Package, Pencil, Trash, User, Users, Waypoints } from "lucide-react";
...
// import { deleteProfileById, reorderResumeProfiles } from "@/actions/builder.action";
...
//                 return await deleteProfileById(profileId, resume?.data?.id!);
//             },
//             onSuccess: () => {
...
//         });
//         const menuItems = [
//             { label: "Edit", icon: <Pencil />, iconClassName: '', onClick: () => console.log(profileId) },
//             { label: "Delete", icon: <Trash />, iconClassName: '', onClick: () => console.log('Billin') },
...
//                     <div className="flex flex-col gap-4 border-4 border-red-700 p-8">
//                         {items.map((profile) => (
//                             <SortableItem key={profile.id} uuid={profile.id}>
//                                 <div className="flex justify-betwween items-center  hover:bg-gray-700/60 w-full">
...
//                                         <Menu triggerLabel={<List size={20} />} items={menuItems} menuClassName="bg-black text-gray-400  shadow-lg" menuItemClassName=" hover:cursor-pointer hover:!bg-gray-300 focus:!bg-gray-300 data-[highlighted]:!bg-gray-300 data-[state=open]:!bg--300 my-2 hover:!text-gray-800" />
...
import React, { useEffect, useRef, useState } from "react";
import { Button } from "../ui/button";
import ProfilesModal from "../Modals/CreateProfileModal";
import { ProfileType, ResumeResponseSchemaType } from "@/schema/builder.schema";
import { List, } from "phosphor-react";
